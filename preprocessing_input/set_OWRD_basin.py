...
def main(tgt_path, field_name='basin_nbr'):
    ...
    """
    logging.info('Setting OWRD basin property')
    ...
    county_geojson = os.path.join(os.getcwd(), 'OWRD_AdminBasins.shp')
    county_field_name = 'basin_nbr'
...
def arg_parse():
    ...
    parser.add_argument(
        'tgt', metavar='SHP', type=valid_shp, help='Target shapefile')
    parser.add_argument(
        '--field', default='OWRD_basin', type=str, help='OWRD Basin Number')
    parser.add_argument(
